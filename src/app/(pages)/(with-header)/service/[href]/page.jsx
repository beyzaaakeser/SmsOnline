      ...
      <div className="flex max-lg:flex-col pt-6 min-h-[65vh]">
        ...
        <div className="flex  flex-col lg:flex-[7] gap-8">
          <div className="relative w-full h-full ">
            ...
            <div className=" w-full h-full inset-0 flex justify-center items-center relative z-10 select-none">
              <video src="/images/video.webm" autoPlay loop muted  className='pointer-events-none select-none'></video>
            </div>
          </div>
        </div>
      </div>
